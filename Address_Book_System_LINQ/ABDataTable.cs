...
namespace Address_Book_System_LINQ
{
    class ABDataTable
    {
        ...
        public DataTable CreateTable(AddressBookModel model)
        {
            ...
            dataTable.Rows.Add("Mr", "Haltung", "A", "Chandrapur", "Maharashtra", "09", "943657", "Mrhaltung@gmail.com","Friends","Office");
            dataTable.Rows.Add("Dipesh", "Chandekar", "A", "Chandrapur", "Maharashtra", "24", "7898765473", "dipesh@gmail.com", "Friends","Home");
            dataTable.Rows.Add("Mithilesh", "Chandekar", "N", "Gadchiroli", "Maharashtra", "07", "76236457", "mithilesh@gmail.com", "Friends","Office");
